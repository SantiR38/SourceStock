...
urlpatterns = [
    ...
    path('articulo/<int:code_articulo>', views.articulo, name='articulo'),
    path('cancelar_unidad/<int:code_articulo>', views.cancelar_unidad, name='cancelar_unidad'),
    path('recibo/<int:sale_id>', views.recibo, name='recibo'),
    path('detalle_entrada/<int:purchase_id>', views.detalle_entrada, name='detalle_entrada'),
