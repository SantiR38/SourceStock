...
class Article(models.Model):
    ...
    porcentaje_descuento = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0)
    precio_descontado = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0)
